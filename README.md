...
По заданию не реализована конечная точка "logout" и контейнеризация с помощью Docker.

Python 3.12.7

Инструкция по развертыванию:
  1. Клонировать репозиторий
  2. Активировать виртуальное окружение и установить зависимости из файла requirements
